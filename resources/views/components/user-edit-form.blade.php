...
<div class="form-group">
  ...
  <div class="col-sm-8">
    <input name="name" id="name" type="text" class="form-control1" value="@if( old('name') ) {{old('name')}} @elseif( isset($user) ) {{$user->name}} @endif" placeholder="Username..." />
  </div>
  <div class="col-sm-2">
    <p class="help-block">
      @if ($errors->has('name'))
...
<div class="form-group">
  <label for="selector1" class="col-sm-2 control-label">Supermarket</label>
  <div class="col-sm-8">
