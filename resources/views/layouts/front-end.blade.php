		...
		<div id="delete-confirmation" class="modal fade" role="dialog">
		  <div class="modal-dialog">
		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-footer">
						<a href="/remove-user/{{Auth::id()}}" class="btn btn-danger" href="" name="button">Yes delete my account</a>
		        <button type="button" class="btn btn-success" data-dismiss="modal">No, please dont</button>
		      </div>
		    </div>
