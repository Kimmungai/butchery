												    ...
												    <div class="chrt-bars">
														<!--<div class="col-md-6 chrt-two">
														 <h3 class="sub-tittle">Bar Chart </h3>
															<div id="chart2"></div>
															<script src="{{url('/front-end/js/fabochart.js')}}"></script>
															<script>
															...
															<h3 class="sub-tittle">Sales Chart </h3>
																<div id="chartdiv"></div>
																			<script>
									...
									<div class="bottom-grids">
										<div class="dev-table">
                                            ...
                                            <div class="dev-widget dev-widget-transparent">
                                                ...
                                                <p>Today 20% of staff was engaged</p>
                                                <div class="dev-stat"><span class="counter">20</span>%</div>
                                        ...
                                        <div class="col-md-4 dev-col mid">
                                            ...
                                            <div class="dev-widget dev-widget-transparent dev-widget-success">
                                                ...
                                                <div class="dev-stat">Ksh. <span class="counter">75,332</span></div>
                                                <div class="progress progress-bar-xs">
                                        ...
                                        <div class="col-md-4 dev-col">
                                            ...
                                            <div class="dev-widget dev-widget-transparent dev-widget-danger">
                                                ...
                                                <p>Onion needs immediate re-stocking</p>
                                                <div class="dev-stat"><span class="counter">5</span></div>
                                                <div class="progress progress-bar-xs">
